...
const BookingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f6efe7_0%,#eef5ff_100%)] p-3 sm:p-5">
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/60 bg-white/80 p-4 shadow-2xl backdrop-blur sm:p-6">
